...
const Navbar = () => {
  ...
  const dropdownLinks = [
    ...
    { name: "Upload Notice", icon: Bell, href: "/dashboard/upload-notice", color: "text-gray-700" },
    { name: "Upload Assignment", icon: FileText, href: "/dashboard/upload-assignment", color: "text-gray-700" },
