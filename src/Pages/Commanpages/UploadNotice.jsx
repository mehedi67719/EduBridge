    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Create and manage notices for different user roles across the campus</p>
          {dbUser && (
          ...
          <div className="lg:col-span-7">
            ...
            {uiState.showPreview && (
              <div className="bg-white rounded-2xl shadow-xl border mt-6">
                ...
                <div className="p-6">
                  <div className={`p-4 rounded-xl border-l-4 ${getPriorityColor(formData.priority)} bg-white`}>
                    <div className="flex gap-2 mb-2 flex-wrap">
                      <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getPriorityColor(formData.priority)}`}>
                    ...
                    <p className="text-gray-600 mb-3">{formData.noticeContent || 'Notice content will appear here...'}</p>
                    {formData.imageUrls.length > 0 && (
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 sticky top-24">
              <div className="px-6 py-4 border-b bg-gradient-to-r from-indigo-50 to-purple-50">
                ...
                <p className="text-xs text-gray-500 mt-1">Select target audience for your notice</p>
              </div>
