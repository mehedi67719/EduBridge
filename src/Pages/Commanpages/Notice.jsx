      ...
      <div className="container mx-auto px-4 pt-10 lg:pt-14 pb-6">
        <div className="text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
            Stay updated with all campus announcements, events, and important
            notifications
          </p>
        </div>
      </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 sticky top-24 border border-white/50">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-amber-50 to-orange-50 text-amber-700 text-xs rounded-full font-medium">
                    Examination
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-700 text-xs rounded-full font-medium">
                    Results
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 text-xs rounded-full font-medium">
                    Workshop
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 text-xs rounded-full font-medium">
                    Scholarship
                  </span>
                </div>
              </div>
