    ...
    try {
      ...
      if (result && result.user) {
        Swal.fire({
          ...
          text: `Welcome back to EduBridge!`,
          icon: "success",
                ...
                <div className="h-full flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-indigo-200 mb-8 leading-relaxed">
                      A complete digital ecosystem for modern education. Manage
                      classes, assignments, attendance, results and
